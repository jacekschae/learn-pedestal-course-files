...
(comment
  ...
  (d/transact (-> cr/system :database :conn)
    {:tx-data [{:recipe/recipe-id #uuid"d7bc7677-6707-4af3-a2aa-0119e6fa6941"
                :recipe/display-name "name"
                :recipe/public? true
                :recipe/prep-time 30
                :recipe/image-url "img"
                :recipe/owner [:account/account-id "auth|5fbf7db6271d5e0076903601"]}]})
